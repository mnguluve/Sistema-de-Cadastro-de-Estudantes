...
<div class="card">
  <div class="card-header">
    <h3>Perfil do Utilizador <span class="float-right"> <a href="index.php" class="btn btn-primary">Voltar</a> </h3>
  </div>
  <div class="card-body">
    <?php
    ...
    <div style="width:600px; margin:0px auto">
      <form class="" action="" method="POST">
        ...
        <div class="form-group">
          <label for="username">Seu nome de utilizador</label>
        ...
        <div class="form-group <?php if (Session::get("roleid") == '1' && Session::get("id") == $getUinfo->id) {
                echo "d-none";
              } ?>">
          <div class="form-group">
            <label for="sel1">Selecione o papel do utilizador</label>
            <select class="form-control" name="roleid" id="roleid">
              <?php if($getUinfo->roleid == '1'){ ?>
              <option value="1" selected='selected'>Administrador</option>
              <option value="2">Editor</option>
              <option value="3">Apenas Utilizador</option>
              ...
              <option value="1">Administrador</option>
              <option value="2">Editor</option>
              <option value="3" selected='selected'>Apenas Utilizador</option>
              <?php } ?>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary" href="changepass.php?id=<?php echo $getUinfo->id;?>">Alterar palavra-passe</a>
        </div>
